...
# Compute previous index, wrap if at beginning
prev_index=$(((current_index - 1 + ${#spaces_on_display[@]}) % ${#spaces_on_display[@]}))

# Focus the previous space
yabai -m space --focus "${spaces_on_display[$prev_index]}"
